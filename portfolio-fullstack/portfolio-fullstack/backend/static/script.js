...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Same-origin now that Django serves the frontend too — no absolute URL needed
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        const mailto = `mailto:nyaswanthkumar93@gmail.com?subject=${encodeURIComponent(subject)}&body=${body}`;
